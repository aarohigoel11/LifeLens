  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Continue your journey to self-mastery</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button type="button" className="text-sm text-indigo-600 hover:text-indigo-700 transition">
            Forgot password?
          </button>
        </div>
